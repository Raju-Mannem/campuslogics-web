    ...
    return (
        <section className="min-h-screen px-4 sm:px-6 lg:px-8">
                <article className="bg-white w-full flex flex-col gap-4 border-x border-gray-200 p-12">
                        ...
                        <p className="text-gray-600 text-lg">
                            Our Service may contain links to third-party web sites or services that are not owned or controlled by campuslogics.
                        </p>
                        <p className="text-gray-600 text-lg">
                        ...
                        <p className="text-gray-600 text-lg">
                            campuslogics reserves the right to change, suspend access to, or remove any or all of the content on the Website at any time, for any reason, in its sole discretion. campuslogics also reserves the right to discontinue the Website at any time, either temporarily or permanently. In the event of the removal of any content from the Website or the termination of the Website, you will not be entitled to any refund or payment.
                        </p>
                        <p className="text-gray-600 text-lg">
