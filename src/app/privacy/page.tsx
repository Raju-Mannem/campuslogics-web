    ...
    return (
        <section className="min-h-screen px-4 sm:px-6 lg:px-8">
            <article className="bg-white w-full flex flex-col gap-4 border-x border-gray-200 p-12">
                ...
                <p className="text-gray-600 text-lg">Cookies are files with small amount of data, which may include an anonymous unique identifier. Cookies are sent to your browser from a web site and stored on your computer&apos;s hard drive.</p>

                <p className="text-gray-600 text-lg">We use &apos;cookies&apos; to collect information. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service.</p>
                ...
                <p className="text-gray-600 text-lg">
                    Note that campuslogics has no access to or control over these cookies that are used by third-party advertisers.
                </p>
