...
import { Image as PImage } from '@/generated/prisma/client';
import Image from 'next/image';
import { useLoader } from '@/context/LoaderContext';
import { searchImages } from '@/services/image.services';
      ...
      {images?.length > 0 && (
        <div className="grid grid-cols-3 gap-4">
          {images?.map((image) => (
            <div
              key={image.id}
              className={`group relative border-2 rounded-lg cursor-pointer overflow-hidden ${
