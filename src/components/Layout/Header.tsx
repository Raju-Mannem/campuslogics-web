...
export default async function Header() {
  ...
  const links = [
    {
      href: '/internships',
      label: 'Internships',
      icon: <BriefcaseBusinessIcon className="size-5 sm:size-5" />,
    },
    {
      href: '/scholarships',
      label: 'Scholarships',
      icon: <GraduationCapIcon className="size-5 sm:size-5" />,
    },
  ...
  return (
    <HeaderContent links={links} isAuthenticated={!!session?.user} logoutButton={logoutButton} />
  );
}
